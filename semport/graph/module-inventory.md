...
| `tool_node.py` | ~1,830 | `ToolNode` (executes tool calls from the last AIMessage, returns ToolMessages), `tools_condition` (route to tools vs END), `InjectedState`/`InjectedStore` injection, `ValidationNode`. |
