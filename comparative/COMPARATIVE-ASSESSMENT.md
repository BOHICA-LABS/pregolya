...
| NE-07 | P-66 | `.expect()` panic in library constructor (WASM engine init) | All library constructors return `Result`; `Default` must not delegate to fallible ctor; CI: `check-no-panic` lint |
