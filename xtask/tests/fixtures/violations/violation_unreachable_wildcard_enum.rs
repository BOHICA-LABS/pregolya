...
// The `has_qualified_path_before` heuristic INCORRECTLY grants exemption here —
// the presence of named-variant arms only confirms current exhaustiveness; it does
// NOT prove future-proof safety. A new enum variant added downstream makes the `_`
// arm reachable and causes a panic in production.
//
