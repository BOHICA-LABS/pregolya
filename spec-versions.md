...
changelog:
  - "1.4 (D-366/2026-09-18, state-manager): BC-INDEX §Changelog (v4.63→v4.64; S-1.01 LOCAL adv OBS-1 records-only); BC-2.14.002 §Changelog (v1.13→v1.14; {INV-004}/§Architecture Anchors prose precision corrected to reflect actual layering; no behavioral change). Census UNCHANGED: BC 149 / VP 43 / stories 53."
...
| Artifact | Version | Last Updated | Changed By |
|----------|---------|-------------|------------|
| specs/behavioral-contracts/BC-INDEX.md | v4.64 | 2026-09-18 | state-manager |
