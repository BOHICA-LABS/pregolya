...
| `ferrochain-openai` | crate-level — BaseChatModel impl | ferrochain-openai | SS-08 | HIGH | — | ≥ 90% | P5 |
| `ferrochain-anthropic` | crate-level — BaseChatModel impl | ferrochain-anthropic | SS-08 | HIGH | — | ≥ 90% | P5 |
| `ferrochain-ollama` | crate-level — BaseChatModel impl | ferrochain-ollama | SS-08 | HIGH | — | ≥ 90% | P5 |
