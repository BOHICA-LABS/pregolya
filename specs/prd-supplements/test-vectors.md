...
| BC-2.09.008 | SS-09 | 11 | — | `TV-NNN` | | StateGraph-as-MCP-Tool Wrapping (GraphAgentTool; mcp::graph_tool); VP-016 proptest P1 seed ({INV-001} STATE-ISOLATION) |
...
**Total vectors (134 authored BCs):** 752 canonical test vectors (TV Count column) + 11 golden test vectors (GTV Count column, BC-2.07.002 only) = **763 total vectors** across 134 BC files.
