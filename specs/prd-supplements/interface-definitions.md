...
phase: 1d
modified: [DC-62, DC-63, DC-64, DC-65, DC-66, D-370]
changelog:
  - "3.24 (S-1.02-adv-pass-1/D-370/2026-09-22, state-manager): E-CORE-012 individual library-layer omission note added (HttpClientBuildFailed, TRANSPORT→502, RetryHint: Never — construction-time config error; BC-2.14.004 {EC-006} authoritative gate #33 raise site; pregolya-core::http HTTP client factory). Disposition census updated: 52 HTTP + 34 individual (+1 E-CORE-012) + 62 blanket = 148 (was: 50 HTTP + 25 individual + 62 blanket = 137 — stale census from round-5/2026-08-26 corrected to reflect all additions through S-1.02-adv-pass-1/2026-09-22)."
