...
changelog:
  ...
  - "1.4 (2026-07-23, F-P139-01b, burst-239): Fix stale 'BC-2.04.001 immutability' citations (Description, Invariants, Related BCs). F-P139-01 (deep-read pass) found that BC-2.04.001 contains no immutability invariant — that BC is about put_writes timing. The anchor is now BC-2.04.001 Inv-5, which was added in this same burst (F-P139-01a) as a new general checkpoint append-only invariant covering all in-run operations including compaction."
...
(interface-definitions.md §BudgetPolicy): `None` when no token ceiling is configured;
