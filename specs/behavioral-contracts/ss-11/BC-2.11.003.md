...
- `architecture/module-decomposition.md §ferrochain-graph` — `graph::provenance` row: dispatch at `RAGRetrieval` boundary; N chunks → N independent `evaluate` calls (HIGH, SS-11)
