...
| D-02 | Standard-tests conformance suite — no competitor has this | market-intel §4 #2 | CAP-011 | (none; process-level differentiator) | pregolya-standard-tests conformance BC |
...
| D-04 | Idiomatic async-first trait design with typed ContentBlock and 2D error taxonomy | market-intel §4 #4; CONFLICT-6 | CAP-001, CAP-002, CAP-016 | DI-008 (constructor Result), DI-014 (no silent errors) | PregolyaError 2D struct BC; typed ContentBlock BC |
| D-05 | Provider conformance + LangChain Python v1 migration story | market-intel §4 #5 | CAP-009, CAP-010, CAP-011 | (process-level; no runtime invariant) | pregolya-standard-tests + "Coming from LangChain?" docs |
...
| Combined (all four) | None | This four-part combination = pregolya's unique market position |
