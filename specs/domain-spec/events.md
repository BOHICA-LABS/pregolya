...
changelog:
  ...
  - "1.9 (2026-07-23): Fix burst 242 BA residual sweep — Command notation: 3 enum-variant form occurrences of `Command::Resume(PreToolDecision)` corrected to struct kwarg form `Command(resume=PreToolDecision)` per BC-2.05.004/F-P120-01 adjudication. Sites: §ToolApprovalResolved description, §ToolApprovalResolved Trigger, §StreamEventEmitted Trigger. TD-VSDD-060 sweep: zero Command:: enum-form occurrences remain in this file's body text."
