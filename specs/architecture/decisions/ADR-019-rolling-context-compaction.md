...
variants. BC-2.06.006 authored (SS-06): `compaction_event` variant contract established
in BC-2.06.006.

BC-2.10.005 and BC-2.10.006 authored (SS-10): compaction trigger semantics, watermark
arithmetic, and journal entry requirements established in BC-2.10.005 and BC-2.10.006.
