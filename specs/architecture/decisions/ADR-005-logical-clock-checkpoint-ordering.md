...
|-------|---------------------|------------------------------|-------------------|-------------|
| `Runnable<Input, Output>` | `invoke`, `stream`, `batch` | Blanket → `DynRunnable`; via `Tool: Runnable<ToolInput, ToolOutput>`, blanket → `DynTool` | YES (after R34 fix) | FIXED in interface-definitions.md §Runnable |
