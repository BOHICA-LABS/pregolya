...
modules are enumerated in `## Purity Classification` below (80 total rows after FIX-BURST-272:
32 Pure Core + 36 Effectful Shell + 12 Boundary). Enforcement invariants follow
