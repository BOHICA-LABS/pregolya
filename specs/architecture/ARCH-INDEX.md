...
changelog:
  - "1.54 (round-44/F-P2A184-01+F-P2A184-02+F-P2A184-03+F-P2A185-01+F-P2A187-01+F-P2A187-02+F-P2A187-03/2026-08-30): interface-definitions.md (§BaseChatModel, §DynRunnableAdapter, §DynTool): F-P2A184-01 [HIGH] E0562 stream_chat boxing — async fn desugared to nested impl Trait inside impl Future, illegal on stable Rust; boxed to fn stream_chat(...) -> impl Future<Output = Result<Pin<Box<dyn Stream<Item = Result<AiMessageChunk, PregolyaError>> + Send>>, PregolyaError>> + Send; F-P2A184-02 [MED] DynRunnableAdapter::stream sketch corrected (outer Result match + re-boxing for O→Value); F-P2A184-03 [MED] §DynTool doc-comment 'impl Stream return' → 'RPITIT impl Future return — opaque, non-dyn-compatible'. ADR-005 (§BaseChatModel adjudication + §Send-Bounded RPITIT table): F-P2A184-01 BaseChatModel row and adjudication text updated; F-P2A184-03 §Runnable+§Tool adjudication prose updated. api-surface.md (§DynTool): F-P2A184-03 stale 'impl Stream' reference updated. ADR-025 (§Send-Bounded RPITIT table): F-P2A184-01 BaseChatModel row updated. ADR-029 (§Decision 5 internal-panic row): F-P2A187-02 [MED] E-GRAPH-019 status 'anticipated' → 'live' + discharged census annotations removed (TD-VSDD-091/volatile-census-in-prose). Separate domain changes (specialist scope): BC-2.09.008 (v3.5→v3.6): F-P2A187-01 [MED, CWE-209] EC-003 corrected — E-GRAPH-011 dynamic primary (E-GRAPH-019 static uniform-treatment defense-in-depth); S-2.11 (v1.31→v1.32): F-P2A187-03 [MED] Red-Gate count 13→12 (R43 AC-038-sweep residue). Hooks: F-P2A185-01 [MED, CWE-248] verify-security-literal-propagation.sh R04 canonical_hint/echo/header corrected to workspace-root-only framing. Census UNCHANGED: 134 BCs / 17 VP / 138 EC / 40 stories. ADR count UNCHANGED: 29."
