...
changelog:
  ...
  - "2.03 (S-1.02-adv-pass-2/D-371/2026-09-22, state-manager): S-1.02 story spec v1.3→v1.4 — AC-017 (BC-2.14.003 EC-007: check-no-panic gate discipline; FLAGS bare assert! without # Panics doc or BC-ID message and FLAGS wildcard unreachable!; EXEMPTS exhaustive-match unreachable! and documented programmer-error-guard assert!; two POL-31 live-violation fixtures); AC-018 (BC-2.14.003 EC-006: PregolyaError::new/to_problem/component_lowercase programmer-error guards compliant under narrow EC-006 exception); AC-019 (BC-2.14.004 EC-006: E-CORE-012 build-failure test non-ignored and invokes same production path as build_client()). Edge cases EC-007/EC-008/EC-009 added. BC table Covered ACs updated (BC-2.14.003 adds AC-017/AC-018; BC-2.14.004 adds AC-019). Census UNCHANGED: BC 149 / VP 43 / EC 148 / TV 845 / stories 53 / pts 377 / ADR 31 / SS 24 / crates 22."
  - "2.02 (S-1.02-adv-pass-1/D-370/2026-09-22, state-manager): S-1.02 story spec v1.2→v1.3 — AC-015 (whitespace-only API key rejection → E-CORE-005 VAL) and AC-016 (HttpClient build failure propagation → E-CORE-012 TRANSPORT) added; BC tables updated (BC-2.14.004 {EC-006} + BC-2.14.006 {EC-006}/TV-006); Token Budget updated. test-vectors→v3.29 (BC-2.14.006 TV count 5→6). Census: EC 147→148 (+E-CORE-012); TV 844→845 (+TV-006/BC-2.14.006). BC 149 / VP 43 / TV 845 / stories 53 / pts 377 / ADR 31 / SS 24 / crates 22 (BC/VP/stories/pts/ADR/SS/crates UNCHANGED)."
