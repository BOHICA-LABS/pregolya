...
### AC-001 (traces to BC-2.15.001 postcondition 1 — memory_set/get/delete)
...
### AC-002 (traces to BC-2.15.001 postcondition 2 — vector search)
...
### AC-003 (traces to BC-2.15.001 postcondition 3 — hybrid search)
...
### AC-004 (traces to BC-2.15.001 postcondition 4 — cross-thread persistence)
...
### AC-005 (traces to BC-2.15.001 postcondition 5 — storage capacity)
...
### AC-006 (traces to BC-2.15.002 postcondition 1 — scope isolation)
...
### AC-007 (traces to BC-2.15.002 postcondition 2 — no implicit scope elevation)
...
### AC-008 (traces to BC-2.15.002 postcondition 3 — scope fields flow to SQL WHERE)
...
### AC-009 (traces to BC-2.15.002 edge case EC-003 — ScopeAccessDenied)
...
### AC-010 (traces to BC-2.15.002 edge case EC-004 — NoScopeContext)
...
### AC-011 (traces to BC-2.15.003 postcondition 1 — atomic GDPR erasure)
...
### AC-012 (traces to BC-2.15.003 postcondition 2 — GdprErasureReceipt)
